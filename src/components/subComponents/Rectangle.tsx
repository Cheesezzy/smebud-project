...
const Rectangle = () => {
    return (
        <div className='border-1 w-full h-[650px] max-w-[400px] rounded-sm p-5 mt-5 shadow-lg'>
            ...
            <div className='flex justify-between mt-[24px]'>
                ...
                <div className='flex flex-1 justify-around w-[148px] h-[29px] mx-[12px] align-center rounded-lg p-1 bg-[#F2F5FF]'>
                    ...
                    <p className='text-[#3A56CD] self-center text-[14px]'>verified listing</p>
                </div>
            ...
            <div className='border-t-2 p-[16px] '>
                <p className='text-[16px] text-[#696E7C]'>Lorem ipsum dolor sit amet consectetur. Nulla convallis eget praesent tortor id. </p>
            </div>
            ...
            <div className="mx-auto flex mt-[18px]">
                <span className="mx-3">
                    <button className=' bg-transparent border-2 border-[#3A56CD] w-40 h-11 rounded-lg text-[#3A56CD] text-lg'>Watch</button>
                </span>
                <span className="mx-3">
                    <button className=' w-40 h-11 rounded-lg bg-[#F1F4FF] text-[#3A56CD] text-lg'>View listing</button>
                </span>
            </div>
